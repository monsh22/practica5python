...
def guardar_datos():
    ...
    if (es_entero_valido(edad) and es_decimal_valido(estatura) 
        and es_entero_valido_de_10_digitos(telefono) and es_texto_valido(nombres)
        ...
        messagebox.showerror("Error", "Por favor, ingrese los datos validos en los campos.")
...
label_telefonos = tk.Label(ventana, text="Telefono :")
label_telefonos.pack()
